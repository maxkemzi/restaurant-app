...
it("renders content passed to buttonSlot prop", () => {
	const product = createProduct();
	const buttonSlotContent = "Content";
	render(<ProductCard product={product} buttonSlot={buttonSlotContent} />);

	const buttonSlot = screen.getByText(buttonSlotContent);
	expect(buttonSlot).toBeInTheDocument();
});
